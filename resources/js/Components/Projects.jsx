...
const Projects = ({ proyectos = [] }) => {
    ...
    return (
        <div className="w-full px-4 flex flex-col gap-8 flex-grow">
            <div className={`grid grid-cols-1 md:grid-cols-2 ${allProyectos.length > 1 ? 'lg:grid-cols-3' : 'lg:grid-cols-1'} gap-6`}>
...
//         if (currentPage <= 3) {
//             // Mostrar las páginas cercanas al principio
//             for (let i = 2; i <= Math.min(4, totalPages - 1); i++) {
//                 pages.push(i);
//             }

//             // Si hay más páginas, agregar puntos suspensivos y la última página
//             if (totalPages > 5) {
//                 pages.push('...');
//             }
//         }
...
//             // Agregar puntos suspensivos antes de las últimas páginas
//             if (totalPages > 5) {
//                 pages.push('...');
//             }

//             // Mostrar las páginas cercanas al final
...
//         else {
//             pages.push('...'); // Puntos suspensivos después de la primera página
...
//             pages.push('...'); // Puntos suspensivos antes de la última página
//         }
...
//                 href="#"
//                 onClick={(e) => typeof page === 'number' && handlePaginationClick(page, e)}
//                 className={`px-4 py-2 rounded-md mx-1 ${currentPage === page ? 'bg-black text-white dark:bg-white dark:text-black' : 'bg-transparent text-black dark:text-white'} 
//                 ${typeof page === 'string' ? 'pointer-events-none' : 'hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black'}
//                 transition-colors duration-300`}
//             >
//                 {page}
...
//                     <a key={proyecto.id} href={proyecto.url} data-aos="fade-up">
//                         <div className='block bg-white border border-gray-200 rounded-lg shadow-lg transition-all hover:scale-105 duration-300'>
//                             <img src={proyecto.image} alt={proyecto.title} className="w-full h-52 object-cover rounded-t-lg mb-4" />
//                             <div className='px-4 pb-4'>
//                                 <h2 className="text-black text-2xl font-semibold mb-2">{proyecto.title}</h2>
//                                 <div className="text-gray-700">
...
//                         href="#"
//                         onClick={(e) => handlePaginationClick(Math.max(1, currentPage - 1), e)}
//                         className={`px-4 py-2 rounded-md mx-1 bg-transparent text-black hover:bg-black hover:text-white transition-colors duration-300`}
//                     >
//                         <FontAwesomeIcon icon={faAngleLeft} className='w-full h-5' />
//                     </a>
//                     {renderPages()}
...
//                         href="#"
//                         onClick={(e) => handlePaginationClick(Math.max(1, currentPage - 1), e)}
//                         className={`flex items-center px-4 py-2 rounded-md bg-transparent text-black hover:bg-black hover:text-white transition-colors duration-300`}
//                     >
//                         <FontAwesomeIcon icon={faAngleLeft} className='w-full h-5' />
//                     </a>
//                     {renderPages()}
