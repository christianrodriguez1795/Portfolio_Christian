...
//     return (
//         <div className="w-full max-w-xl px-6 md:p-6">
//             <form onSubmit={handleSubmit} noValidate className="w-full">
//                 <div data-aos="fade-right" className='w-full flex flex-col md:flex-row gap-6'>
...
//                             required
//                             className="peer pl-0 p-3 pt-5 w-full border-b-2 border-t-0 border-l-0 border-r-0 border-black 
...
//                         onChange={handleChange}
//                         required
//                         className="peer pl-2 p-3 pt-4 w-full border-2 rounded-md border-black 
//                         focus:outline-none focus:ring-0 focus:border-gray-300 dark:border-white dark:bg-black dark:text-white 
...
const ContactForm = ({ setSnackbar }) => {
    ...
    return (
        <div className="w-full max-w-2xl px-6 md:p-6">
            <form onSubmit={handleSubmit} noValidate className="w-full">
                <div data-aos="fade-right" className='w-full flex flex-col md:flex-row gap-6'>
                    <div data-aos="fade-right" className="relative flex-grow overflow-x-hidden">
                        <input
